...
def SVD_DR(X_train, X_test=None, Y_train=None, **kwargs):
    clf = sklearn.decomposition.TruncatedSVD(**kwargs)
    Z = clf.fit_transform(X_train)
    return Z

def KPCA_DR(X_train, X_test=None, Y_train=None, **kwargs):
    clf = sklearn.decomposition.KernelPCA(**kwargs)
    Z = clf.fit_transform(X_train)
    return Z

def ICA_DR(X_train, X_test=None, Y_train=None, **kwargs):
    clf = sklearn.decomposition.FastICA(**kwargs)
    Z = clf.fit_transform(X_train)
    return Z
