    ...
    if plot_type == '2D':
        ...
        if Y_continuous == True:
             ...
             layout2D_sample = go.Layout(
                    title = go.layout.Title(x=0.5,text = 'DVM and MSE v.s Number of Samples',xanchor="center"),
                    xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Samples",font = dict(size=25))),
                    yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM & MSE",font = dict(size=25))),
                    )
             ...
             layout2D_feature = go.Layout(
                title = go.layout.Title(x=0.5,text = 'DVM and MSE v.s Number of Features',xanchor="center"),
                xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Features",font = dict(size=25))),
                yaxis =  go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM & MSE",font = dict(size=25))),
                )
        else:
            trace2D_sample_Accuracy = go.Scatter(x = sample_seq,
                        ...
                        name = 'Accuracy')
            layout2D_sample = go.Layout(
                    title = go.layout.Title(x=0.5,text = 'DVM and Accuracy v.s Number of Features',xanchor="center"),
                    xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Features",font = dict(size=25))),
                    yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM & Accuracy",font = dict(size=25))),
                    )
            trace2D_feature_Accuracy = go.Scatter(x = feature_seq,
                        y = Accuracy_feature,
                        mode = 'lines',
        ...
        layout2D_sample_NoAccuracy = go.Layout(
                title = go.layout.Title(x=0.5,text = 'DVM v.s Number of Samples',xanchor="center"),
                xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Samples",font = dict(size=25))),
                yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM",font = dict(size=25))),
                )
        ...
        layout2D_feature_NoAccuracy = go.Layout(
            title = go.layout.Title(x=0.5,text = 'DVM v.s Number of Features',xanchor="center"),
            xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Features",font = dict(size=25))),
            yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM",font = dict(size=25))),
            )
        if GiveAccuracy:
        ...
        if Y_continuous == True:
            ...
            layout3D = go.Layout(
                scene = dict (
                xaxis = dict(title = "Number of Features",titlefont=dict(size=17)),
                yaxis = dict(title = "Number of Samples",titlefont=dict(size=17)),
                zaxis = dict(title = "DVM and MSE",titlefont = dict(size=17)),),)
            trace2D_sample_Accuracy = go.Scatter(x = sample_seq,
                        y = Accuracy[:,-1],
                        mode = 'lines',
                        name = 'MSE')
            ...
            layout3D = go.Layout(
                ...
                xaxis = dict(title = "Number of Features",titlefont=dict(size=17)),
                yaxis = dict(title = "Number of Samples",titlefont=dict(size=17)),
                zaxis = dict(title = "DVM and Accuracy",titlefont = dict(size=17)),),)
            trace2D_sample_Accuracy = go.Scatter(x = sample_seq,
                        y = Accuracy[:,-1],
                        mode = 'lines',
                        name = 'Accuracy')
            layout2D_sample = go.Layout(
                    title = go.layout.Title(x=0.5,text = 'DVM and Accuracy v.s Number of Samples',xanchor="center"),
                    xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Samples",font = dict(size=25))),
                    yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM & Accuracy",font = dict(size=25))),
                    )
            trace2D_feature_Accuracy = go.Scatter(x = feature_seq,
        ...
        layout3D_NoAccuracy = go.Layout(
                ...
                xaxis = dict(title = "Number of Features",titlefont=dict(size=17)),
                yaxis = dict(title = "Number of Samples",titlefont=dict(size=17)),
                zaxis = dict(title = "DVM",titlefont = dict(size=17)),),)
        ...
        layout2D_feature_NoAccuracy = go.Layout(
            title = go.layout.Title(x=0.5,text = 'DVM v.s Feature Number',xanchor="center"),
            xaxis = go.layout.XAxis(title = go.layout.xaxis.Title(text = "Number of Features",font = dict(size=25))),
            yaxis = go.layout.YAxis(title = go.layout.yaxis.Title(text = "DVM",font = dict(size=25))),
            )
