    ...
    if plot_type == '2D':
        ...
        if GiveAccuracy:
            if Y_continuous == True:
                ...
                plotly.offline.plot({"data": [trace2D_sample_DVM,trace2D_sample_Accuracy,trace2D_sample_BER],
                             "layout":layout2D_sample}, auto_open=False, filename = filename + '2D_Sample' + '.html')
                plotly.offline.plot({"data": [trace2D_feature_DVM,trace2D_feature_Accuracy,trace2D_feature_BER],
                             "layout":layout2D_feature}, auto_open=False, filename = filename + '2D_feature' + '.html')
        else:
            if Y_continuous == True:
                ...
                plotly.offline.plot({"data": [trace2D_sample_DVM,trace2D_sample_BER],
                             "layout":layout2D_sample_NoAccuracy}, auto_open=False, filename = filename + '2D_Sample' + '.html')
                plotly.offline.plot({"data": [trace2D_feature_DVM,trace2D_feature_BER],
                             "layout":layout2D_feature_NoAccuracy}, auto_open=False, filename = filename + '2D_feature' + '.html')
